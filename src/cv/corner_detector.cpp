...
namespace mynt {
    ...
    float CornerDetector::shiTomasiScore(const mynt::YImg8 &img, int u, int v) {
//        assert(img.type() == CV_8UC1);
    ...
    void CornerDetector::detect_features(const mynt::YImg8 &image, std::vector<mynt::Point2f> &features, std::vector<double> &nm_scores) {
